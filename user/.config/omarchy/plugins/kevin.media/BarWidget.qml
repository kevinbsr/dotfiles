...
BarWidget {
  ...
  readonly property var sourcePlayers: mediaService ? mediaService.sourcePlayers : directPlayers
  ...
  function selectPlayer() {
    if (preferredPlayer && directPlayers.indexOf(preferredPlayer) !== -1) return preferredPlayer
        ...
        Repeater {
          ...
          BorderSurface {
            ...
            MouseArea {
              ...
              onClicked: root.preferredPlayer = sourceRow.player
            }
          }
        }
      }
